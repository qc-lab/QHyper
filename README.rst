...
* :doc:`Problems <docs/source/generated/QHyper.problems>` - classes that describe different types of problems, such as the Knapsack Problem or the Traveling Salesman Problem.

* :doc:`Solvers <docs/source/generated/QHyper.solvers>` - Classes that define different types of solvers, e.g., quantum/hybrid solvers like the Quantum Approximate Optimization Algorithm or the Constrained Quadratic Model, but also classical solvers like Gurobi.

* :doc:`Optimizers <docs/source/generated/QHyper.optimizers>` - Classes that implement different types of (hyper)optimizers.
