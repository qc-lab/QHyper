...
def test_TSP():
    ...
    assert problem.objective_function.as_dict() == {
        ('x0', 'x4'): 0.128983563339732,
        ('x0', 'x5'): 0.966795420417069,
        ('x0', 'x7'): 0.128983563339732,
        ('x0', 'x8'): 0.966795420417069,
        ('x1', 'x3'): 0.128983563339732,
        ('x1', 'x5'): 1.0,
        ('x1', 'x6'): 0.128983563339732,
        ('x1', 'x8'): 1.0,
        ('x2', 'x3'): 0.966795420417069,
        ('x2', 'x4'): 1.0,
        ('x2', 'x6'): 0.966795420417069,
        ('x2', 'x7'): 1.0,
        ('x3', 'x7'): 0.128983563339732,
        ('x3', 'x8'): 0.966795420417069,
        ('x4', 'x6'): 0.128983563339732,
        ('x4', 'x8'): 1.0,
        ('x5', 'x6'): 0.966795420417069,
        ('x5', 'x7'): 1.0,
    }
