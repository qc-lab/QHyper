...
class HQAOA(PQC):
    ...
    def run_opt(
        ...
        probs = self.get_probs_func(problem, list(weights))(opt_args[1 + len(problem.constraints):].reshape(2, -1))
    ...
    def get_hopt_args(
        ...
        return hyper_args if hyper_args else params_init['hyper_args']
